...
export class Multisig implements Contract {
  ...
  async sendNewOrder(
    ...
    if (this.configuration === undefined) {
      throw new Error(
        "Configuration is not set: use createFromConfig or loadConfiguration",
      );
    }
    ...
    if (via.address !== undefined) {
      ...
      throw new Error(
        "If sender address is not known, addrIdx and isSigner parameres required",
      );
    }
